...
# to-do item completed by G.Mclindon 6/8/2017
numbers_to_display = [0,50,100]
for i, numbers_to_display in enumerate(numbers_to_display):
    print("{:4}".format(numbers_to_display))
